...
public class cramer {
	...
	public static void insertarM(int a[][]){
		for(int i=0; i<a.length; i++){
			for(int j=0; j<a[i].length;j++){
				a[i][j]=Integer.parseInt(showInputDialog(null,"Inserte un valor entero de la posicion: [ "+i+" , "+j+" ]"));	
			}
		}
	...
	public static void mostrarM(int a[][]){
		for(int i=0; i<a.length; i++){
			for (int j=0; j<a[i].length;j++){
				showMessageDialog(null,"El resultado de la matriz en la posicion  [ "+i+" , "+j+ " ] es: "+a[i][j]);
			}
		}
	...
	public static void insertarV(int a[]){
		for(int i=0; i<a.length; i++){		
				a[i]=Integer.parseInt(showInputDialog(null,"Inserte un valor entero del vector en la posicion: [ "+i+" ]" ));			
		}
	...
	public static void mostrarV(int a[]){
		for(int i=0; i<a.length; i++){
			showMessageDialog(null,"El resultado de la matriz en la posicion  [ "+i+" ] es: "+a[i]);			
		}
	...
	public static float[] cramer(int a[][], int b[]){
		...
		if(det==0){
			showMessageDialog(null,"No tiene solucion");			
			return Rcramer;
		}
	...
	//muestra los resultados de X
		...
		for(int i=0; i<a.length; i++){
			showMessageDialog(null,"El resultado de X_"+i+" es: "+a[i]);			
		}
   ...
   public static void main(String args[]){
		int tam=0;
		tam=Integer.parseInt(showInputDialog(null,"Cual es el tamaño de la matriz"));
		...
		showMessageDialog(null,"Inserte los valores de la matriz");
		insertarM(a); //llamada a procedimiento
		showMessageDialog(null,"Inserte los valores del resultado");
		insertarV(b);
		
		
		cmr=cramer(a,b);
		showMessageDialog(null,"Los valores para las X's son:");
		mostrarX(cmr);
